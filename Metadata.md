...
## :one: Column Description for dim_customers:
...
## :two: Column Description for dim_products:
...
## :three: Column Description for dim_date:
...
## :four: Column Description for dim_targets_orders:
...
## :five: Column Description for fact_order_lines:
...
## :six: Column Description for fact_orders_aggregate:
